...
Exercise 12: Create a directory called my_dir with permissions 751 in the working directory. User has all read, write, and execute permissions. Group has read and execute permissions. Others have just execute permission.

Exercise 13: Change gorup owner to school for the file hello

Exercise 14:* Change owner to betty and the group owner to holberton for all files and directories in current directory.

Exercise 15: Changes the owner and group owner of file _hello to betty and holberton respectively.
